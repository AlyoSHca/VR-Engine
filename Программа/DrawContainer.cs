...
namespace Visualizer
{
    public partial class DrawContainer : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            g.Clear(Color.FromArgb(255, 82, 85, 85));
            Multiplier = 100;
            ...
            foreach (SceneObject DrawObject in DrawScene.ObjectList)
            {
                ...
                else
                {
                    ...
                    Obj.Mesh.Verteces = Obj.Mesh.Verteces.Select(v => new Vertex(v.Position.X * scale*2.5, v.Position.Y * scale*2.5, v.Position.Z)).ToList();
                }
